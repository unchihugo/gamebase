...
import gamePopularImage from "../images/gamePopular.png";
        ...
        <div className="-mb-16">
            <div className="pt-32 font-display bg-slate-800">
                <h1 className="text-5xl lg:text-6xl font-bold text-center text-slate-100 mb-6">
                    <img src={icon} alt="" style={{ objectFit: "cover", width: "200px", height: "200px" }} className="mx-auto" data-sal="slide-up" data-sal-delay="100" data-sal-duration="1000" />
                    <h1 className="text-5xl lg:text-6xl font-bold text-center text-slate-100 mb-6" data-sal="slide-up" data-sal-delay="500" data-sal-duration="1000">
                        Welcome to <span className="text-red-500">Gamebase</span>
                        <span className="text-red-500 animate-pulse font-normal">|</span>
                    </h1>
                </h1>
                <p className="text-xl text-center text-slate-100" data-sal="slide-up" data-sal-delay="1000" data-sal-duration="1000">
                ...
                <div className="flex justify-center mt-10" data-sal="slide-up" data-sal-delay="1000" data-sal-duration="1000">
            ...
            <div className="flex flex-col lg:flex-row justify-center container mx-auto" >
                <div className="w-full lg:w-1/2 p-4 flex flex-col justify-center items-center" data-sal="slide-up" data-sal-delay="300" data-sal-duration="1500">
                    <h2 className="text-2xl font-bold text-center text-slate-100 mb-4 font-display">Find Your Favorite Games</h2>
                    <p className="text-xl text-center text-slate-400 font-display">
            ...
            <div className="flex flex-col lg:flex-row justify-center mt-20 container mx-auto" >
                ...
                <div className="w-full lg:w-1/3 p-4 flex flex-col justify-center items-center" data-sal="slide-up" data-sal-delay="300" data-sal-duration="1500">
            ...
            <div className="flex flex-col lg:flex-row justify-center mt-20 container mx-auto" >
                <div className="w-full lg:w-2/3 p-4">
                    <img src={gamePopularImage} alt="" style={{ width: "auto", height: "100%", objectFit: "cover" }} />
                </div>
                <div className="w-full lg:w-1/3 p-4 flex flex-col justify-center items-center" data-sal="slide-up" data-sal-delay="300" data-sal-duration="1500">
                    <h2 className="text-2xl font-bold text-center text-slate-100 mb-4 font-display">Find Out What's Popular</h2>
                    <p className="text-xl text-center text-slate-400 font-display">
                        Gamebase shows you curated games that are popular right now. You might even find a new favorite game to play!
                    </p>
                </div>
            </div>
            <p className="mt-20 text-2xl font-bold text-center text-slate-100 font-display" data-sal="slide-up" data-sal-delay="700" data-sal-duration="2000">
